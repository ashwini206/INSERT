...
<div class="container register">
           ...
           SELECT `id`, `firstname`, `lastname`, `email`, `phone`, `password`, `hobby`, `image`, `answer`, `gender` FROM `employee` WHERE 1                 </li> -->
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Apply as a Employee</h3>
                                <form action="<?php echo base_url()?>Employee/insert" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <select name="hobby" class="form-control">
                                                <option class="hidden"  selected disabled>Please </option>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Your Answer *" name="answer" value="" name="answer"/>
                                        </div>
